...
const ConcertItem = ({title, location, city, comment, url, date, sourceUrl}: Concert) => {
  return (
    <div className='concertitem__box'>
      ...
      <div className='concertitem__field'><div className='concertitem__location_city'><a href={sourceUrl} target='_blank' rel='noreferrer noopener'>{location}</a>, {city}</div></div>
